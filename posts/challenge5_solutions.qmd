...
We'll use `select()` to pull out the variables that will make the dataset a bit more manageable. There are likely **many** variables of interest contained in these data that would paint a more nuanced picture of public education in the US, but we may have to email the DOE for the documentation for those.
...
Wow, those are a skewed histogram. We should probably remove some outliers to make it more readable.
